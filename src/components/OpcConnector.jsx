    ...
    <div className="p-4 bg-white rounded border border-gray-300 w-full">
      <form onSubmit={sendMessage}>
        ...
        <div className="mb-4">
          ...
          <input type="text" value="opc.tcp://192.168.0.114:4841/freeopcua/server" onChange={(e) => setOpcUrl(e.target.value)} className="w-full p-2 border rounded-sm border-gray-300" required />
        </div>
